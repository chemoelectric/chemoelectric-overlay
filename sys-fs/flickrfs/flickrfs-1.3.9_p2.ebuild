...
UBUNTU_VERSION=1.3.9
UBUNTU_ORIG=.1
UBUNTU_DIFF=.1-9.2ubuntu2

DESCRIPTION="Virtual filesystem for flickr online photosharing service"
HOMEPAGE="https://launchpad.net/ubuntu/+source/flickrfs"
SRC_URI="
	https://launchpad.net/ubuntu/+archive/primary/+files/${PN}_${UBUNTU_VERSION}${UBUNTU_ORIG}.orig.tar.gz
	https://launchpad.net/ubuntu/+archive/primary/+files/${PN}_${UBUNTU_VERSION}${UBUNTU_DIFF}.diff.gz
"
LICENSE="GPL-2+"
