...
DESCRIPTION="Interval arithmetic for Ada"
HOMEPAGE="https://sourceforge.net/projects/intervalarithmeticforada/"
SRC_URI="mirror://sourceforge/intervalarithmeticforada/${PN}_${PV/./_}.tgz -> ${P}.tar.gz"
...
src_prepare() {
	default
	rm -R strings_edit* tables* units* || die
}
