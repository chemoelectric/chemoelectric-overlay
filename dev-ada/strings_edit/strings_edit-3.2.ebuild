...
DESCRIPTION="String editing and formatting library for Ada"
HOMEPAGE="https://sourceforge.net/projects/stringsedit/"
SRC_URI="mirror://sourceforge/stringsedit/strings_${PV/./_}.tgz -> ${P}.tar.gz"
