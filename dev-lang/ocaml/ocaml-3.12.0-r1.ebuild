...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/ocaml/ocaml-3.12.0-r1.ebuild,v 1.1 2011/06/11 17:39:25 aballier Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/patch-00-camlp4-3.12.0-module-type-of-fix" || die "camlp4 patch failed"
}
