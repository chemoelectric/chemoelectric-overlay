...
# $Header: /var/cvsroot/gentoo-x86/media-libs/fontconfig/fontconfig-2.8.0.ebuild,v 1.1 2009/11/22 23:53:58 dirtyepic Exp $
...
src_prepare() {
	...
	if use chemoelectric; then
		epatch "${FILESDIR}"/fontfig-2.8.0-patch-2009.11.23.13.19.43.diff
	fi
