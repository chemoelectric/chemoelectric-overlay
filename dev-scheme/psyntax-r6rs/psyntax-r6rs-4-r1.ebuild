...
HOMEPAGE="http://www.cs.indiana.edu/chezscheme/r6rs-libraries/"
SRC_URI="http://www.cs.indiana.edu/chezscheme/r6rs-libraries/${PN}-rev${PV}.tgz"
...
src_install() {
	...
	for i in ${SCHEME_USES} ; do
		if use ${i} ; then
			...
			[ -e ${i}.r6rs.ss ] && {
				cp -af ${i}.r6rs.ss "${D}"/${PSYNTAX_LOCATION} \
